...
class SherpaOnnxClient:
    ...
    def __init__(self, model_path: Optional[str] = None, tokens_path: Optional[str] = None, voice_id: Optional[str] = None):
        try:
            ...
            logging.error("Please install sherpa-onnx library to use the SherpaOnnxClient")
        ...
        try:
            ...
            logging.error("Please install threading library to use the SherpaOnnxClient")
