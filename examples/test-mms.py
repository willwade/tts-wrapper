...
# Create a directory for MMS models in the user's home directory
model_dir = os.path.expanduser("~/mms_models")
os.makedirs(model_dir, exist_ok=True)

client = MMSClient(model_dir)
tts = MMSTTS(client)
# 
# # # pausng
# try:
#     ssml_text = tts.ssml.add(f"This is me speaking with Speak function and MMS")
...
# try:
#     output_file = Path(f"output_MMS.mp3")
