...
def main():
    ...
    print(f"GoogleTransClient is an instance of AbstractTTS: {isinstance(client, AbstractTTS)}")
    ...
    try:
        ...
        audio_bytes = client.synth_to_bytes("This is a test of the GoogleTrans TTS engine.")
    ...
    try:
        ...
        client.synth("This is a test of the GoogleTrans TTS engine.", temp_path)
