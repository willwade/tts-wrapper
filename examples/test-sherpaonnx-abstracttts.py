...
def main():
    ...
    print(f"SherpaOnnxClient is an instance of AbstractTTS: {isinstance(client, AbstractTTS)}")
    ...
    try:
        ...
        audio_bytes = client.synth_to_bytes("This is a test of the SherpaOnnx TTS engine.")
    ...
    try:
        ...
        client.synth("This is a test of the SherpaOnnx TTS engine.", temp_path)
